...
import integrationController from '../../../code/behavioral/command/integration.controller.ts?raw';
import integrationService from '../../../code/behavioral/command/integration.service.ts?raw';
import integrationModule from '../../../code/behavioral/command/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'command.controller.ts', code: integrationController },
  { filename: 'command.service.ts', code: integrationService },
  { filename: 'command.module.ts', code: integrationModule },
]} />
