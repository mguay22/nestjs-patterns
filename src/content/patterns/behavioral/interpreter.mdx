...
import integrationController from '../../../code/behavioral/interpreter/integration.controller.ts?raw';
import integrationService from '../../../code/behavioral/interpreter/integration.service.ts?raw';
import integrationModule from '../../../code/behavioral/interpreter/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'interpreter.controller.ts', code: integrationController },
  { filename: 'interpreter.service.ts', code: integrationService },
  { filename: 'interpreter.module.ts', code: integrationModule },
]} />
