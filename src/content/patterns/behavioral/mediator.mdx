...
import integrationController from '../../../code/behavioral/mediator/integration.controller.ts?raw';
import integrationService from '../../../code/behavioral/mediator/integration.service.ts?raw';
import integrationModule from '../../../code/behavioral/mediator/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'mediator.controller.ts', code: integrationController },
  { filename: 'mediator.service.ts', code: integrationService },
  { filename: 'mediator.module.ts', code: integrationModule },
]} />
