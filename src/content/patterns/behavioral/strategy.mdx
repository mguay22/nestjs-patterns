...
import integrationController from '../../../code/behavioral/strategy/integration.controller.ts?raw';
import integrationService from '../../../code/behavioral/strategy/integration.service.ts?raw';
import integrationModule from '../../../code/behavioral/strategy/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'strategy.controller.ts', code: integrationController },
  { filename: 'strategy.service.ts', code: integrationService },
  { filename: 'strategy.module.ts', code: integrationModule },
]} />
