...
import integrationController from '../../../code/creational/abstract-factory/integration.controller.ts?raw';
import integrationService from '../../../code/creational/abstract-factory/integration.service.ts?raw';
import integrationModule from '../../../code/creational/abstract-factory/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'abstract-factory.controller.ts', code: integrationController },
  { filename: 'abstract-factory.service.ts', code: integrationService },
  { filename: 'abstract-factory.module.ts', code: integrationModule },
]} />
