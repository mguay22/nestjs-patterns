...
import integrationController from '../../../code/creational/builder/integration.controller.ts?raw';
import integrationService from '../../../code/creational/builder/integration.service.ts?raw';
import integrationModule from '../../../code/creational/builder/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'builder.controller.ts', code: integrationController },
  { filename: 'builder.service.ts', code: integrationService },
  { filename: 'builder.module.ts', code: integrationModule },
]} />
