...
import integrationController from '../../../code/structural/composite/integration.controller.ts?raw';
import integrationService from '../../../code/structural/composite/integration.service.ts?raw';
import integrationModule from '../../../code/structural/composite/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'composite.controller.ts', code: integrationController },
  { filename: 'composite.service.ts', code: integrationService },
  { filename: 'composite.module.ts', code: integrationModule },
]} />
