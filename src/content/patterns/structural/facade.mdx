...
import integrationController from '../../../code/structural/facade/integration.controller.ts?raw';
import integrationService from '../../../code/structural/facade/integration.service.ts?raw';
import integrationModule from '../../../code/structural/facade/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'facade.controller.ts', code: integrationController },
  { filename: 'facade.service.ts', code: integrationService },
  { filename: 'facade.module.ts', code: integrationModule },
]} />
