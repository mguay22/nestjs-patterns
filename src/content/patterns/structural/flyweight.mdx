...
import integrationController from '../../../code/structural/flyweight/integration.controller.ts?raw';
import integrationService from '../../../code/structural/flyweight/integration.service.ts?raw';
import integrationModule from '../../../code/structural/flyweight/integration.module.ts?raw';
...
<CodeTabs tabs={[
  { filename: 'flyweight.controller.ts', code: integrationController },
  { filename: 'flyweight.service.ts', code: integrationService },
  { filename: 'flyweight.module.ts', code: integrationModule },
]} />
